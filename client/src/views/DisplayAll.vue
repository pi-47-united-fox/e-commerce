<template>
	<div class="container">
		...
		<div class="columns is-multiline banner-col is-centered">
			<div class="card column is-3 mx-3 mb-3" v-for="product in products" :key="product.id">
					...
					<div class="media">
						<div class="media-content">
							...
							<table class="table is-narrow">
								<tr>
									<th>Price:</th>
									<td class="is-size-7">Rp. {{ product.price.toLocaleString("id") }}</td>
								</tr>
								<tr>
									<th>Category:</th>
				...
				<footer class="card-footer">
					<a @click="addToCart(product.id)" class="card-footer-item">Add to Cart</a>
				</footer>
			</div>
		</div>
	</div>
